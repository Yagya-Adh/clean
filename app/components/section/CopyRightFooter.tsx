const CopyRightFooter = () => {
  ...
  return (
    <section className="max-w-screen-3xl mx-auto w-full flex flex-col md:flex-row items-center justify-center md:justify-between border-t-2 border-t-black py-3 sm:py-10">
      <p className="md:text-2xl py-2 sm:py-4 font-inter font-medium md:font-normal text-center max-w-60 md:max-w-xl md:px-2 tracking-wider">
        © {currentYear} Cleaners. All Rights Reserved.
      </p>
      <p className="md:text-2xl sm:py-4 font-inter font-medium md:font-normal text-center max-w-52 md:max-w-xl md:px-2 py-2">
        Powered By{" "}
