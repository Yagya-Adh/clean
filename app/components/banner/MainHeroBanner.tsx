  ...
  return (
    <section className="max-w-screen-2xl mx-auto px-4 py-10">
      <div className="rounded-4xl bg-hero-main bg-no-repeat bg-cover p-10 sm:p-52 md:px-72 md:py-52 lg:p-96 lg:py-85 w-full flex flex-col justify-center">
        <div className=" relative lg:-top-72 left-0 flex flex-col justify-center items-center text-center font-inter z-10 border border-white/15 backdrop:blur-3xl rounded-3xl p-10 lg:p-10 bg-white/15 backdrop-blur-2xl">
          ...
          <button className="bg-white rounded-l-full rounded-r-full px-10 lg:px-20 my-5 hover:bg-clean-green-10 ease-in-out transition-all duration-500">
