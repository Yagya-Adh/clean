      ...
      <div className="rounded-4xl bg-hero-main bg-no-repeat bg-cover p-6  lg:py-80 max-w-full flex flex-col justify-center">
        <div className="relative lg:-top-64 left-0 flex flex-col justify-center items-center text-center font-inter z-10 border border-white/15 backdrop:blur-3xl rounded-3xl p-10 md:p-4 md:w-1/2 mx-auto bg-white/15 backdrop-blur-2xl">
          <div className="flex flex-row justify-center items-center mb-4 w-full">
            ...
            <h3 className="text-sm lg:text-xl text-clean-black-10 ml-2 uppercase font-inter font-normal">
              Go-to Cleaners
            </h3>
          </div>
          <h1 className="font-inter font-light text-4xl sm:text-5xl lg:text-7xl xl:text-8xl sm:py-4 uppercase animate-flipTopDownIn">
            Expert <br />
            <span className="font-thin italic">Cleaning</span>
          </h1>
          <p className="text-center text-base   text-clean-black-10 font-inter font-light max-w-md md:max-w-xl animate-flipTopDownIn">
