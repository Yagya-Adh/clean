  ...
  return (
    ...
    >
      <div className="group relative z-20 text-center flex flex-col justify-center items-center">
        <p className="translate-y-4 transform group-hover:-translate-y-10 ease-in-out transition-all duration-500 xl:text-2xl 2xl:text-3xl text-clean-black-10 z-20">
          {text}
        </p>
        <p className="translate-y-10 transform group-hover:-translate-y-4 ease-in-out transition-all duration-500 xl:text-2xl 2xl:text-3xl text-clean-black-10 z-20">
          {text}
        </p>
