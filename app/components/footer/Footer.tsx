  ...
  return (
    <footer className="bg-clean-green-10 mt-36 relative px-4">
      ...
      <section className="max-w-screen-5xl px-4 lg:px-10 mx-auto relative py-4 2xl:py-20 -translate-y-24">
        <div className="flex flex-col justify-center md:flex-row lg:justify-between items-center md:grid-cols-2 gap-0 sm:gap-10 2xl:flex 2xl:justify-between 2xl:px-20 2xl:gap-80 place-items-start h-full w-full 2xl:w-full">
          <div>
            <FooterLeft />
          </div>
          <div>
