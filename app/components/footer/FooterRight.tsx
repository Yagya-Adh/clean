          ...
          {list.innerItem?.map((inner) => (
            <Link href={inner.linkPath} key={inner.id}>
              <div className="text-center overflow-hidden h-10 sm:h-12 group md:my-2">
                <div className="tracking-wide 2xl:tracking-normal translate-y-4 group-hover:-translate-y-16 ease-in-out transition-all duration-500 text-clean-black-10 text-xs xl:text-2xl font-normal font-inter h-10">
                  {inner.item}
                </div>
                <div className="tracking-wide 2xl:tracking-normal translate-y-9 group-hover:-translate-y-6 ease-in-out transition-all duration-500 text-clean-black-10 text-xs xl:text-xl 2xl:font-normal 2xl:max-w-xl font-normal font-inter h-10">
                  {inner.item}
                </div>
              </div>
            </Link>
